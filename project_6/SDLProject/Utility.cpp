...
void Utility::draw_object(ShaderProgram* program, glm::mat4 &object_model_matrix, GLuint &object_texture_id) {
    program->set_model_matrix(object_model_matrix);
    glBindTexture(GL_TEXTURE_2D, object_texture_id);
    glDrawArrays(GL_TRIANGLES, 0, 6); // we are now drawing 2 triangles, so we use 6 instead of 3
}

void Utility::render(ShaderProgram* program, GLuint texture_id) {
    ...
    // Bind texture
    draw_object(program, m_model_matrix, texture_id);
